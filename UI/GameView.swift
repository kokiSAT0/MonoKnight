    ...
    init(
        ...
        _viewModel = StateObject(
            wrappedValue: GameViewModel(
                ...
                dungeonGrowthStore: dungeonGrowthStore,
                dungeonRunResumeStore: dungeonRunResumeStore,
                rogueTowerRecordStore: rogueTowerRecordStore ?? RogueTowerRecordStore(),
                tutorialTowerProgressStore: tutorialTowerProgressStore ?? TutorialTowerProgressStore(),
                onRequestGameCenterSignIn: onRequestGameCenterSignIn,
                onRequestReturnToTitle: onRequestReturnToTitle,
                onRequestStartDungeonFloor: onRequestStartDungeonFloor,
    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: $viewModel.showingResult) {
            ResultView(
                ...
                rogueTowerRecordText: viewModel.rogueTowerRecordText,
