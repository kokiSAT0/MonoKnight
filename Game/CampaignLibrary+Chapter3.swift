...
extension CampaignLibrary {
    static func buildChapter3() -> CampaignChapter {
        let stage31 = targetStage(chapter: 3, index: 1, title: "縦横選択", summary: "縦横選択カードで、目的地に近づく軸を選びます。", goalCount: 8, deckPreset: .standardWithOrthogonalChoices, secondaryObjective: .finishWithFocusAtMost(maxFocusCount: 3), scoreTarget: 290, unlockRequirement: .chapterTotalStars(chapter: 2, minimum: 12))
        ...
        let stage33 = targetStage(chapter: 3, index: 3, title: "桂馬選択", summary: "桂馬の選択カードで大きく位置を変え、次の目的地へ備えます。", goalCount: 9, deckPreset: .standardWithKnightChoices, secondaryObjective: .finishWithFocusAtMost(maxFocusCount: 3), scoreTarget: 310, unlockRequirement: .stageClear(stage32.id))
        ...
        let stage37 = targetStage(chapter: 3, index: 7, title: "全選択カード", summary: "選択カードを幅広く使い、次の目的地候補まで含めて位置を決めます。", goalCount: 11, deckPreset: .standardWithAllChoices, secondaryObjective: .finishWithinMoves(maxMoves: 24), scoreTarget: 350, unlockRequirement: .stageClear(stage36.id))
