...
private extension MoveCard {
    ...
    static let patternRegistry: [MoveCard: MovePattern] = {
        ...
        mapping[.straightUp1] = .relativeSteps([MoveVector(dx: 0, dy: 1)])
        mapping[.straightDown1] = .relativeSteps([MoveVector(dx: 0, dy: -1)])
        mapping[.straightRight1] = .relativeSteps([MoveVector(dx: 1, dy: 0)])
        mapping[.straightLeft1] = .relativeSteps([MoveVector(dx: -1, dy: 0)])
