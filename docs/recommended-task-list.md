...
- [ ] 成長塔9F構成の実プレイ調整<!-- 巡回、鍵、罠、ワープを統合した成長塔で、3F/6F/9Fの区切り報酬と難度上昇が自然に伝わるか確認する -->
- [ ] 高難度ローグライク塔 v0 の実プレイ調整<!-- 試練塔を実際に周回し、永続成長なしで罠、敵、ワープ、床割れの負荷が読み切れるかを確認する -->
...
- [x] 3本立て塔構成への再編<!-- 基礎塔、成長塔、試練塔の3本に整理し、巡回/鍵扉/ワープ/罠の内容を成長塔9Fへ統合した -->
