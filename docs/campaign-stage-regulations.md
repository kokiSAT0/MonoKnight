...
| 8-1 固定ワープ基礎 | 5×5 / 中央固定 | `fixedWarpSpecialized` | 固定ワープ目的地ローテーション | 38 手以内 | 400 以下 | +3 / +2 / +1 / 0 | 7-8 拡張行動総決算クリア |
...
| `fixedWarpSpecialized` | 固定ワープカード 1 種 | 固定ワープのみ重み 1 で連続配布 | 8-1 固定ワープ基礎。 |
...
| ステージ | 盤面 / スポーン | 山札プリセット | 特殊タイル / カード | セカンダリ条件 | スコア上限 | ペナルティ設定 | アンロック条件 |
|----------|-----------------|----------------|----------------------|----------------|------------|-----------------|----------------|
| 8-1 固定ワープ基礎 | 5×5 / 中央固定 | `fixedWarpSpecialized` | 固定ワープカードのみを連続供給 | 38 手以内 | 400 以下 | +3 / +2 / +1 / 0 | 7-8 拡張行動総決算クリア |
