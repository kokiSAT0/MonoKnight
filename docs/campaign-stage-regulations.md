...
| 2-1 重踏応用 | 4×4 / 中央固定 | `standard` | 二度踏み ×2 | ペナルティ合計 5 以下 | 350 未満 | +3 / +1 / +1 / 0 | 1-2 クリア |
...
| 5-2 障害物応用 | 5×5 / 任意スポーン | `standardWithAllChoices` | 障害物 ×3 | ペナルティ合計 2 以下 | 490 以下 | +5 / +5 / +1 / 0 | 5-1 クリア |
| 5-8 最終試験 | 5×5 / 任意スポーン | `standardWithAllChoices` | 障害物 ×3＋複合 | 34 手以内＆ノーペナ | 430 以下 | 0 / 0 / +1 / 0 | 5-7 クリア |
...
|----------|-----------------|------------------------|----------------|------------|-----------------|----------------|
| 2-1 重踏チュートリアル | 4×4 / 中央固定 | {(1,1):2, (2,2):2} | ペナルティ合計 5 以下 | 450 以下 | +3 / +1 / +1 / 0 | 1-8 クリア |
...
- スポーンは 5-1・5-3・5-5 のみ中央固定で、それ以外のステージは任意スポーンを採用する。
...
| 5-2 障害物応用 | 5×5 / 任意 | 障害物 {(1,1), (3,3), (2,2)} | ペナルティ合計 2 以下 | 490 以下 | +5 / +5 / +1 / 0 | 5-1 クリア |
...
| 5-8 最終試験 | 5×5 / 任意 | 障害物 {(1,1), (3,3), (2,2)} ＋ 2/3/4 回混合 {(0,4):2, (4,0):3, (2,4):4} ＋ トグル {(1,3), (3,1)} | 34 手以内＆ノーペナ | 430 以下 | 0 / 0 / +1 / 0 | 5-7 クリア |
